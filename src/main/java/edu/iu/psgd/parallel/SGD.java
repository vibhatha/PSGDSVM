...
public abstract class SGD {
    ...
    public abstract void sgdEnsemble() throws NullDataSetException, MatrixMultiplicationException;

    public abstract void bSgd() throws NullDataSetException, MatrixMultiplicationException;
